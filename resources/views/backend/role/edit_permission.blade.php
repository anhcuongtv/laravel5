@extends('backend')
@section('content')
<div id="page-heading"><h1>Edit Permission</h1></div>
...
<tr>
	...
	<div id="content-table-inner">
        ...
        {!! Form::model($permission,['method'=>'PATCH','action'=>['Backend\RoleController@update_permission',$permission->id]]) !!}
            @include('backend.form.permission')
        {!! Form::close() !!}
</div>
