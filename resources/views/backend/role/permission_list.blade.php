...
<!--  start page-heading -->
	<div id="page-heading">
		...
		<h3><a href="{{ url('admin/permission/add') }}">Add Permission</a></h3>
	</div>
	<!-- end page-heading -->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left minwidth-1"><a href="">Permission Name</a>	</th>
                ...
                <tr @if($index%2!=0) class="alternate-row" @endif>
                    ...
                    <td class="options-width">
                        <a href="{{url('admin/permission/edit',$permission['id'])}}" title="Edit" class="icon-1 info-tooltip"></a>
                        <a onclick="if(!confirm('Are you sure to delete this item?')){return false;};" href="{{url('admin/permission/delete',$permission['id'])}}" title="Delete" class="icon-2 info-tooltip"></a>
                    </td>
                </tr>
				@endforeach
			...
			<div id="actions-box">
				...
				<div id="actions-box-slider">
					<a onclick="if(!confirm('Are you sure to delete this item?')){return false;};" href="" class="action-delete">Delete</a>
				</div>
				<div class="clear"></div>
			</div>
			<!-- end actions-box........... -->
